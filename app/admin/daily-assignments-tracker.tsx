...
const PAGE_TITLE = 'Team Daily Assignment – Weekly Tracker';
const PAGE_SUBTITLE = 'Current-week fairness view using the latest saved schedule for each working day.';
const HEADER_TITLE = 'Team Daily Assignments Tracker';
