...
export const STAFF: Staff[] = [
  ...
  { id: '27', name: 'Natalie', phone: '+61401619414', color: '#FF6FB3', gender: 'female' },
  { id: '28', name: 'Paneta', phone: '+61450430147', color: '#FF6FB3', gender: 'female' },
...
export const DEFAULT_CHORES: Chore[] = [
  ...
  { id: '10', name: 'Take bins out to front of property - (Monday Afternoons)' },
